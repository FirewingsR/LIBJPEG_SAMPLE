...
public class MainActivity extends AppCompatActivity {
    ...
    public void click(View view) {
        ...
        JpegUtils.native_Compress(inputBitmap, 70, Environment.getExternalStorageDirectory() + "/girl_lib.jpg");
        Toast.makeText(this, "执行完成", Toast.LENGTH_SHORT).show();
        String filePath = Environment.getExternalStorageDirectory() + "/girl_lib.jpg";
